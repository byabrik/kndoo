...
- (void) doInitialSetup {
    ...
    dispatch_async(sessionQueue, ^{
        ...
        AVCaptureDevice *videoDevice = [TakeVideoViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:AVCaptureDevicePositionBack];
...
- (void)viewWillAppear:(BOOL)animated
{
    dispatch_async([self sessionQueue], ^{
        ...
        __weak TakeVideoViewController *weakSelf = self;
        [self setRuntimeErrorHandlingObserver:[[NSNotificationCenter defaultCenter]
                                               ...
                                               usingBlock:^(NSNotification *note) {
                                                   ...
                                                   TakeVideoViewController *strongSelf = weakSelf;
                                                    dispatch_async([strongSelf sessionQueue], ^{
                                                        
                                                        // Manually restarting the session since it must have been stopped due to an error.
                                                        [[strongSelf session] startRunning];
                                                        [[strongSelf recordButton] setTitle:NSLocalizedString(@"Record", @"Recording button record title")
...
- (IBAction)toggleRecordButton:(id)sender {
    ...
    dispatch_async([self sessionQueue], ^{
        if (![[self movieFileOutput] isRecording])
        {
            ...
            [TakeVideoViewController setFlashMode:AVCaptureFlashModeOff forDevice:[[self videoDeviceInput] device]];
...
- (IBAction)changeCamera:(id)sender
{
    ...
    dispatch_async([self sessionQueue], ^{
        ...
        AVCaptureDevice *videoDevice = [TakeVideoViewController deviceWithMediaType:AVMediaTypeVideo preferringPosition:preferredPosition];
        ...
        if ([[self session] canAddInput:videoDeviceInput])
        {
            ...
            [TakeVideoViewController setFlashMode:AVCaptureFlashModeAuto forDevice:videoDevice];
